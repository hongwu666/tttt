...
public class BenchMark {
	...
	public static void benchmark2(final int loop, final int threads, final float ratio) {
		...
		final MapWrapper[] wrappers = new MapWrapper[] { new HashTableMapWrapper(), new SyncMapWrapper(), new LockMapWrapper(), new RWLockMapWrapper(), new ConcurrentMapWrapper(),
	...
	public static void test() {
		benchmark2(1000, 10, 1);// r:w 1:1
		benchmark2(1000, 10, 0.1f);// r:w 10:1
		benchmark2(1000, 10, 0.01f);// r:w 100:1
		benchmark2(1000, 10, 0.001f);// r:w 1000:1
		// ///
